...
% Narrative source: NARRATIVE.md (B1--B9). Refs: References.md; quotes: Quotes.md.
...
theory. This reasoning then suggests a natural question: are there other
...
is the causal relation between a pair of points. Another crucial feature of
spacetime physics is the \emph{locality of action}~\cite{Einstein1948}:
