...
% theory?
% The clause "more precise than the compatibility of a theory with relativistic
% causality" was trimmed to "a more precise question" to avoid repeating the
% sentence before it; revert if the longer form is wanted.
...
theory. This suggests a more precise question: what does a probabilistic
theory require in order to be distributed over space?}
