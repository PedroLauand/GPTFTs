...
type: paper
date: 2019-04-07
author: [Howard Barnum, Joachim Hilgert]
source-of-record: https://arxiv.org/abs/1904.03753
version-filed: arXiv:1904.03753v1 (2019-04-07)
doi: none recorded on arXiv
journal: none recorded on arXiv
...
Howard Barnum, Joachim Hilgert. First arXiv version 2019-04-07; the copy filed here is arXiv:1904.03753v1,
dated 2019-04-07. The folder is dated by the first arXiv appearance. The
PDF is not kept in the repository; arXiv is the source of record.
Machine-readable extraction: [paper.md](paper.md).

- arXiv: <https://arxiv.org/abs/1904.03753>
- DOI: none recorded on arXiv
- Journal reference (arXiv): none recorded
- arXiv comment: none

## Role in the project

Not in draft.bib. Filed for the axioms catalogue: spectrality and strong symmetry as single-system postulates, and the theorem that they characterise Jordan-algebra (quantum-like) state spaces. The retired notes named it as a terminology source; Müller §5 cites it.
